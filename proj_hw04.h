#ifndef __PROJ_HW04_H__INCLUDED__
#define __PROJ_HW04_H__INCLUDED__


// NOTES FOR UPDATES FOR NEXT TIME:
//
// - Add 'extra' fields to CPUMemory, so that mult/div are possible
// - Pass the 'extra' control bits to execute_CPU()
